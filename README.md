...
mvn clean test                                       # 77 tests, real crypto included
...
src/test/java/...                 77 JUnit 5 tests, mirrored package layout
results/                          committed CSVs backing the numbers in this README
```

## Testing

`mvn clean test` runs 77 tests with no skips and no mocks around the cryptography —
