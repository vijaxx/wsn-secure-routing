...
mvn clean test                                       # 78 tests, real crypto included
...
src/test/java/...                 78 JUnit 5 tests, mirrored package layout
results/                          committed CSVs backing the numbers in this README
```

## Testing

`mvn clean test` runs 78 tests with no skips and no mocks around the cryptography —
